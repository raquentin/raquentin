...
#define MIN_VERSION_clash_audio(major1,major2,minor) (\
  ...
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_clash_audio */
/* package doctest-parallel-0.3.1.1 */
#ifndef VERSION_doctest_parallel
#define VERSION_doctest_parallel "0.3.1.1"
#endif /* VERSION_doctest_parallel */
#ifndef MIN_VERSION_doctest_parallel
#define MIN_VERSION_doctest_parallel(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  3 || \
  (major1) == 0 && (major2) == 3 && (minor) <= 1)
#endif /* MIN_VERSION_doctest_parallel */
...
#define CURRENT_COMPONENT_ID "clash-audio-0.1-inplace-doctests"
