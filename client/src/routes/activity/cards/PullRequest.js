...
export default function PullRequest({repo, title, createdAt}) {
  ...
  function timeSince(date) {
	...
	return (
		<a onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} style={styles.container} href={`https://github.com/${repo}`} target="_blank" rel="noreferrer">
