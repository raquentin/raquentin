...
export default function ThemeLink({which}) {
  ...
  switch (which) {
    case "GitHub":
      return (
        <a href="https://github.com/r4c3" target="_blank"><svg onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} style={styles.icon} version="1.1" viewBox="0 0 16 16"> //* GitHub Icon
    ...
    case "LinkedIn":
      return (
        <a href="https://linkedin.com/in/r4c3" target="_blank"><svg onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} style={styles.icon} version="1.1" viewBox="0 0 16 16"> //* LinkedIn Icon
    ...
    case "ToggleTheme":
      return (
        <svg onClick={toggleIsLightMode} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} style={styles.icon} version="1.1" viewBox="0 0 16 16"> //* Toggle Theme Icon
